...
const { isPlaying, currentArtist } = storeToRefs(useSong);
	...
	<div>
		<div class="w-[calc(100%-240px)] h-[60px] fixed right-0 z-20 bg-[#101010] bg-opacity-80 flex items-center justify-between">
			<div class="flex items-center ml-6">
				<button type="button" class="rounded-full bg-black p-[1px] cursor-pointer">
					<ChevronLeft :size="30" fillColor="#FFFFFF" />
				</button>
				<button type="button" class="rounded-full bg-black p-[1px] ml-4 cursor-pointer">
					<ChevronRight :size="30" fillColor="#FFFFFF" />
				</button>
			</div>
			...
			>
				<div class="flex items-center">
					<img 
						class="rounded-full" 
						width="27"
						src="https://yt3.ggpht.com/yti/AHXOFjVKJP9tq8ypd5iLB69ApeN94VX0u8afahGjpApZ=s88-c-k-c0x00ffffff-no-rj-mo"
					>
					<div class="text-white text-[14px] ml-1.5 font-semibold">Usman Ali</div>
		...
		>
			...
			<ul>
				...
				<MenuItem class="-ml-[1px]" :iconSize="27" name="Like Songs" iconString="liked" pageUrl="/liked" />
			</ul>
			<div class="border-b border-b-gray-700"></div>
			<ul>
				<li class="font-semibbold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #1</li>
				<li class="font-semibbold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #2</li>
				<li class="font-semibbold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #3</li>
				<li class="font-semibbold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #4</li>
			</ul>
		</div>
		<!-- Side Menu -->
